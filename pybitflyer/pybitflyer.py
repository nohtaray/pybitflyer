...
class API(object):
    ...
    def getboardstate(self, **params):
        """Board status
        This will allow you to determine the current status of the board.
        ...
        Response
        --------
        state: one of the following levels will be displayed
        ...
        Docs
        ----
        https://lightning.bitflyer.jp/docs?lang=ja#板の状態
        """
